...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_new:
        await update.message.reply_text(
            ...
            "Составлю персональный план тренировок с учётом твоих данных, "
            "целей и состояния здоровья 💪\n\n"
            "Сейчас пройдём короткую настройку — займёт 2 минуты.\n\n"
            "📋 *Чтобы план был точным и безопасным:*\n"
            "• Указывай реальные данные — вес, рост, уровень подготовки\n"
            "• Обязательно отметь все травмы и ограничения — тренер учтёт их\n"
            "• Если есть хронические заболевания — укажи в поле медицинских особенностей\n\n"
            "Чем точнее данные — тем эффективнее и безопаснее будет программа.\n\n"
