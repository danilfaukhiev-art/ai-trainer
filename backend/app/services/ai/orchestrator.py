...
class AIOrchestrator:
    ...
    async def generate_workout_plan(self, profile: dict) -> dict:
        ...
        equip_map = {
            ...
            "home_barbell": "дома (штанга и гантели, турник)",
            "home_dumbbells": "дома (только гантели, турник, без штанги)",
            "bands": "дома или улица (резинки, петли, собственный вес — без штанги и гантелей)",
            "bodyweight": "дома или улица (только собственный вес, без какого-либо инвентаря)",
            "home": "дома (штанга, гантели, турник)",
            "minimal": "дома или улица (только собственный вес и резинки)",
        }
